      ...
      '<header class="site-header">',
        ...
        '<div class="shell nav-wrap">',
          '<a class="brand" href="/" aria-label="OpenMovers Toronto home">',
            '<img class="brand-logo" src="/assets/images/openmovers-logo.jpg" alt="Open Movers — any time, anywhere">',
          '</a>',
      ...
      '<footer class="site-footer">',
        '<div class="shell footer-main">',
          '<div class="footer-brand">',
            '<a class="brand" href="/" aria-label="OpenMovers Toronto home">',
              '<img class="brand-logo" src="/assets/images/openmovers-logo.jpg" alt="Open Movers — any time, anywhere" loading="lazy">',
            '</a>',
